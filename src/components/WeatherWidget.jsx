 ...
 */
function WeatherWidget( { data = null, dtDiff = 0, city = "City Name" } ) {
    ...
    return (
        ...
        <Container className="text-center">
            <p className="temp">{ data?.temp ? `${data.temp}°C` : "no temperature" }</p>
...
export default WeatherWidget; // Export the WeatherWidget Component